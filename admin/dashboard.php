...
$count_courses = mysqli_num_rows($run_courses_sql);


$get_trainers_sql = "select * from trainers";
$run_trainers_sql= mysqli_query($conn,$get_trainers_sql);
$count_trainers = mysqli_num_rows($run_trainers_sql);

$get_student_sql = "select * from course_complete";
//$run_student_sql= mysqli_query($conn,$get_student_sql);
//$count_students = mysqli_num_rows($run_student_sql);
?>
...
<div class="row"><!-- row no: 2 begin -->
    ...
    <div class="col-lg-4 col-md-6"><!-- col-lg-3 col-md-6 begin -->
        <div class="panel panel-primary"><!-- panel panel-primary begin -->
            ...
            <div class="panel-heading"><!-- panel-heading begin -->
                <div class="row"><!-- panel-heading row begin -->
                    ...
                    <div class="col-xs-9 text-right"><!-- col-xs-9 text-right begin -->
                        <div class="huge"> <?php echo $count_courses; ?> </div>
            ...
            <a href="home.php?view_course"><!-- a href begin -->
        ...
        <div class="panel panel-green"><!-- panel panel-green begin -->
            ...
            <div class="panel-heading"><!-- panel-heading begin -->
                <div class="row"><!-- panel-heading row begin -->
                    ...
                    <div class="col-xs-9 text-right"><!-- col-xs-9 text-right begin -->
                        <div class="huge"> <?php echo $count_trainers; ?> </div>
            ...
            <a href="home.php?view_trainer"><!-- a href begin -->
                <div class="panel-footer"><!-- panel-footer begin -->
    ...
    <div class="col-lg-4 col-md-6"><!-- col-lg-3 col-md-6 begin -->
        <div class="panel panel-orange"><!-- panel panel-yellow begin -->
            ...
            <a href="home.php?view_student_list"><!-- a href begin -->
                <div class="panel-footer"><!-- panel-footer begin -->

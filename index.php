...
<html lang="en">
<style>
    div#slide-100-layer-1.tp-caption.tp-shape.tp-shapewrapper{
        opacity: 0.5 !important;
        margin: 0px 0px 537px !important;
        /*margin-bottom: 500px !important;*/
        /*height: 400px !important;*/
    }
    div#slide-200-layer-1.tp-caption.tp-shape.tp-shapewrapper.rs-toggle-content-active{
        opacity: 0.5 !important;
        margin: 0px 0px 537px !important;
        /*margin-bottom: 500px !important;*/
        /*height: 400px !important;*/
					...
					<ul>	<!-- SLIDE  -->
						...
						data-description="Science says that Women are generally happier">
							...
							<div class="tp-caption tp-shape tp-shapewrapper " 
								...
								data-responsive="off"
								data-frames='[{"from":"opacity:0.4;","speed":1,"to":"o:1;","delay":0,"ease":"Power4.easeOut"},{"delay":"wait","speed":1,"to":"opacity:0.10;","ease":"Power4.easeOut"}]'
							...
							<div class="tp-caption Newspaper-Title   tp-resizeme" 
								...
								style="z-index: 6; font-family:rubik; font-weight:700; text-align:center; white-space: normal;">
									Welcome To CSL Training Institute
							</div>
						...
						data-description="Science says that Women are generally happier">
							...
							<div class="tp-caption tp-shape tp-shapewrapper " 
								...
								data-responsive_offset="off" 
								data-responsive="off"
								data-frames='[{"from":"opacity:0.4;","speed":1,"to":"o:1;","delay":0,"ease":"Power4.easeOut"},{"delay":"wait","speed":1000,"to":"opacity:0.4;","ease":"Power4.easeOut"}]'
								data-textAlign="['left','left','left','left']"
								data-paddingtop="[0,0,0,0]"
								data-paddingright="[0,0,0,0]"
								data-paddingbottom="[0,0,0,0]"
								data-paddingleft="[0,0,0,0]"
								style="z-index: 5;background-color:rgba(2, 0, 11, 0.80);border-color:rgba(0, 0, 0, 0);border-width:0px; opacity: 0.4;">
							</div>
		...
		<div class="content-block">
			...
			<div class="section-area section-sp2 popular-courses-bx">
                <div class="container">
					...
					$run_courses=mysqli_query($conn,$get_courses_sql);
					...
					?>
						...
						<div class="item">
							<div class="cours-bx" style="height: 380px">
								<div class="action-box">
									<img src="assets/images/courses/<?php echo $course_img_id; ?>" alt="">
									<a href="course_details.php?course_id=<?php echo $course_id; ?>" class="btn">Read More</a>
								</div>
								<div class="info-bx text-center">
									<h5><a href="course_details.php?course_id=<?php echo $course_id; ?>"><?php echo substr($course_name,0,20); ?></a></h5>
									<span style="max-width: 100px;"><?php echo substr($course_short_desc,0,20); ?></span>
								</div>
								<div class="cours-more-info">
									...
									<div class="price text-center" style="margin-top: 8px;">
										<!--
										<del><?php //echo $old_price." Tk"; ?></del>
										<h5><?php //echo $new_price." Tk"; ?></h5>
										-->
										<a href="course_details.php?course_id=<?php echo $course_id; ?>" class="btn">More</a>
						...
						<div class="row">
							<div class="col-md-4 col-sm-6">
								<div class="cours-search-bx m-b30">
									...
									<span class="cours-search-text">Over 5 hundreds student</span>
								</div>
							</div>
							<div class="col-md-4 col-sm-6">
								<div class="cours-search-bx m-b30">
									<div class="icon-box">
										<h3><i class="ti-book"></i><span class="counter">8</span></h3>
									</div>
									<span class="cours-search-text">8 Courses.</span>
								</div>
							</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12 text-center heading-bx">
							<h2 class="title-head m-b0">Upcoming <span>Courses</span></h2>
					...
					<div class="upcoming-event-carousel owl-carousel owl-btn-center-lr owl-btn-1 col-12 p-lr0  m-b30">
							...
							<?php
					$get_courses_sql="SELECT * FROM courses WHERE course_category='upcomming'";
					$run_courses=mysqli_query($conn,$get_courses_sql);
					while($row_course=mysqli_fetch_array($run_courses)){
					$course_id=$row_course['course_id'];
					$course_name=$row_course['course_name'];
					...
					$course_start_date=$row_course['course_start_date'];
					$time=strtotime($course_start_date);
					$day=date("d",$time);
					$month=date("F",$time);
								...
								<div class="info-bx d-flex">
									<div>
										<div class="event-time">
											<div class="event-date"><?php echo $day; ?></div>
											<div class="event-month"><?php echo $month; ?></div>
										</div>
									</div>
									<div class="event-info">
										<h4 class="event-title"><a href="course_details.php?course_id=<?php echo $course_id; ?>"><?php echo $course_name; ?></a></h4>
										<ul class="media-post">
											<li><a href="#"><i class="fa fa-clock-o"></i> 7:00am 8:00am</a></li>
											<li><a href="#"><i class="fa fa-map-marker"></i><?php echo $venue; ?></a></li>
										</ul>
										<p><?php echo $course_short_desc; ?></p>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="item">
							<div class="recent-news">
								...
								<div class="info-bx">
									...
									<h5 class="post-title"><a href="#">What Will Education Be Like In The Next 50 Years?</a></h5>
						...
						<div class="item">
							<div class="recent-news">
								...
								<div class="info-bx">
									...
									<h5 class="post-title"><a href="#">Master The Skills Of Education And Be.</a></h5>
